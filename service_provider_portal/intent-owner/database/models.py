...
class Service(Base):
    ...
    video_service_params = relationship(
        "VideoServiceParams", back_populates="service", uselist=False, cascade="all, delete-orphan")
...
class ServiceType(Base):
    ...
    services = relationship(
        "Service", back_populates="type", cascade="all, delete-orphan")
...
class VideoServiceParams(Base):
    ...
    throughput = Column(String, nullable=False)
